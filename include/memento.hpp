...
/* Verify C header version compatibility */
...
public:
    ...
    [[nodiscard]] void* allocate(size_t size, size_t alignment = alignof(max_align_t)) {
...
public:
    ...
    __attribute__((always_inline)) void deallocate(T* ptr, std::size_t n) noexcept {
